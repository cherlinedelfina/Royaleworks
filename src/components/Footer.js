    ...
    <footer className="rw-footer">
      <div className="rw-footer__container">
        ...
        <div className="rw-footer__right">
         <h6 className="rw-footer__colTitle rw-footer__colTitleGold">Get In Touch</h6>


          <a className="rw-footer__contact rw-footer__phone" href="tel:0450353498">
            0450 353 498
        </a>
          <a className="rw-footer__contact muted" href="mailto:hello@royaleworks.com.au">
            hello@royaleworks.com.au
          </a>

          <div className="rw-footer__socials" aria-label="social links">
            <a className="rw-footer__social" href="#" aria-label="Instagram">
      ...
      <div className="rw-footer__bottom">
        <div className="rw-footer__bottomInner">
          <span>All Rights Reserved © {new Date().getFullYear()} · Royale Works Cleaning Co</span>
        </div>
      </div>
    </footer>
  );
